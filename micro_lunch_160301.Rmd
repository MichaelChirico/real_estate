...
## Results: Heterogeneity by Owner Occupancy
```{r, echo = FALSE, results = "asis"}
print.xtable(xtable(dcast(
  properties[(!holdout), to.pct(mean(ever_paid_dec), 0), 
             keyby = .(c("Non-Owner-Occ.", "Owner-Occ."
             )[(mail_address == property_address) + 1], 
             Treatment = treat7)],
  Treatment ~ c, value.var = "V1"), label = "table:delta_by_owner_occ",
  digits = 0, caption = "Treatment Effect by Owner-Occupancy (Property-Level)"), 
