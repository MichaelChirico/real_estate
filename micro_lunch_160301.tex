...
\begin{table}[ht]
\centering
\caption{Descriptive Statistics (Owners, Non-Holdout)} 
\label{table:descriptivesI}
\begin{tabular}{|r|r|}
  \hline
  \hline
Number Observations & 19,361 \\ 
  Amount Due (June) & \$1,872 \\ 
  Assessed Property Value & \$192,832 \\ 
  \% Residential & 77 \\ 
  \% with Philadelphia Mailing Address & 82 \\ 
  Distance to Sheriff's Sale (km) & 2.5 \\ 
  \% with Unique Owner & 87.6 \\ 
  \% Overlap with Holdout & 3.5 \\ 
  \% Overlap with Round 1 & 0.9 \\ 
   \hline
\end{tabular}
\end{table}
...
\begin{frame}{Sample Description: Outcomes}
...
\includegraphics{micro_lunch_160301_files/figure-beamer/fifth-1.pdf}
