...
morale'' motive for paying one's tax taxes.\footnote{See
...
timeliness of income tax payments in the UK and \citeA{castro} study
...
important local tax.\footnote{We conducted an earlier pilot study of
  ...
  property tax payment compliance. The sample in that pilot study was
  too small to draw reliable inference. Moreover, the sample focused
  on repeat instead of first time tax delinquents.} Like the work
...
and the fact that seven of ten tax payers do pay their bills on
...
Our experiment supports two central conclusions. First, saliency of
the tax obligation matters. A simple reminder letter has a
statistically significant and quantitatively significant impact on the
rate of tax payer compliance, though the effect wears off over
...
non-complying taxpayer can be given to a collection agency and the
agency becomes the enforcer of payment. That agency can obtain a
court-order to garnish wages of the violating tax payer. As date S
...
\end{enumerate}
\end{prop}
Our model, thus, nests five competing theories that affect tax payer compliance.
Proposition 1 provides the conceptual framework for the design 
of our field experiment and the interpretation of our empirical findings. As we explain in detail in the next section
we designed the experiment to evaluate the importance of three
competing theoretical explanations of non-compliance: lack of salience, lack of deterrence, and 
lack of benefits or tax morale (Proposition 1.2 - 1.4). We implicitly assume that
all tardy tax payers suffer from present bias and do not test that assumption. 
Our experimental design does not allow us to evaluate the importance of 
activist enforcement strategies (Proposition 1.5). 

Finally, we would like to point out that our model 
abstracts from liquidity constraints as an explanation for non-compliance. While
some of the tax payers are likely to be liquidity constraint, we have no way of assessing
the existence or magnitude of these constraints. Surprisingly, few tax payers
try to negotiate payment plans. Moreover, most tax payers pay in full 
if they pay at all. Both of these observations are consistent with the conjecture that liquidity
constraints may not be of first-order importance in our study. But clearly more research is needed
to assess the importance of liquidity constraints.
...
still owed more than \$10 as of May 15 and had not owed property taxes
in a prior year. None had been assigned to the two outside collection
agencies.  For these 27,264 accounts, we identified the 21,468 tax
account holders responsible for payment. Our experiment therefore
excludes all chronically delinquent taxpayers who owed taxes from
prior years.  Of the 21,468 newly delinquent taxpayers, 2,429
taxpayers owned more than one property.  While all 21,468 taxpayers
were included in the experiment, we focus our empirical work on the
19,333 taxpayers who owned only one property.\footnote{ As a
  ...
  IV and V below. }  Our experiment began with the mailing of reminder
letters in mid-June, 2015 and continued to December 31, 2015.  Of the
unary taxpayers, 16,940 taxpayers received a standard or experimental
reminder letter and 2,088 delinquent taxpayers did not receive a
...
had not adopted such a strategy in our sample year, 2015.\footnote{It
  ...
  lien and the sheriff's sale notification strategies had an indirect
...
The full  template for the other letters are available as an online appendix.}  For
...
each of the seven treatments.Since most property
...
Amount Due (June) & \$1,233 & \$1,256 & \$1,280 & \$1,315 & \$1,289 & \$1,290 & \$1,280 & \$1,299 & 0.92 \\ 
  Assessed Property Value & \$142,630 & \$158,370 & \$130,642 & \$134,334 & \$159,079 & \$130,265 & \$130,936 & \$165,617 & 0.53 \\ 
   \hline
Center City & 109 & 111 & 109 & 115 & 118 & 105 & 114 & 129 & 0.67 \\ 
...
measures of tax compliance behavior. First, did the tax payer make any
contribution at all towards their tax bill; this is the
\textit{ever-paid} response. Second, did the tax payer make a full
payment of their tax bill; this is the \textit{paid-in-full}
response. The sample includes only the 19,028 tax payers who own a
single property.\footnote{We have repeated our analysis for the sample
  of tax payers, including multi-property owning tax payers. Results
...
15). The rate of \textit{ever-paid} compliance for tax payers in the
...
importance of saliency to tax payer compliance behavior.  Our letter
...
(= 3.9/51.4) to the rate of \textit{ever-paid}.  The same
significance, but declining rate of impact on compliance is observed
...
and reminder/sheriff letters had a statistically robust added impact
...
No such consistent improvements in compliance are observed for those
...
of noncompliance (our model's $\rho$) have statistically significant
and quantitatively important additional impacts on compliance, both
...
than a 5 percent increase in the rate of compliance above the reminder
...
with the reminder letter only.  The sheriff letter also offers a
...
from Philadelphia's tardy tax payers.  Among those reminders, only the
neighborhood letter is ever statistically significant and its effect
is negative (!) for those paying in full.\footnote{Our results for
...
(3,900 single property tax payers) and thus the results were less
precisely estimated.  Second, and more importantly, the sample for the
study included only tax payers who had not yet paid by the middle of
November, 2014 (the time of our pilot), and thus are very close to
being what the City will classify as a ``delinquent" tax payer those
who have not paid by December 31 of the tax year.  The sample
therefore consisted of the ``most-tardy" of tardy tax payers.  Of
these ``delinquent" taxpayers who did make a contribution in our pilot
student, the contributions were typically only partial payments of
...
delinquent taxpayers.} Our results are similar in statistical
...
impact on compliance behaviors. \footnote{The six month results need
  ...
  sample of 19,333 tardy tax payers who had not yet paid their taxes,
...
tardy tax payers, our analysis informs two important policy issues.
...
\multicolumn{7}{p{1\textwidth}}{\scriptsize* Sample Size are the
  number of single property tax payers in the treatment group.  Total
  Taxes Owed is the total taxes owed by single property tax payers in
...
For single property owners, the total number of new tax payers above
...
revenues: a benefit to cost ratio of 36.3.
...
the tax morale nudges.  The number of new tax payers above the holdout
...
sheriff's letter to the 16,940 tax payers in our treatment groups we
would have raised \$1.15 million in new revenues rather than \$616,752
-- nearly than twice as much.  The paid share of taxes owed would have
...
\citeyear{Posner-00}. In our model of tax compliance, ``believing in
government" implies relatively high values of $V$.  From the
U.S. Colonies' resistance to British taxation in the 1760's to the
boycotts of the apartheid government's imposition of monopoly user
fees on the residents of Soweto in the 1980's, refusing to pay one's
taxes is a rejection of government's performance, consistent with a
low value of $V$.  In signaling games where there is a cost to
...
equilibrium; see Besley, Jensen, and Persson
...
tax payer compliance for property tax collections fell from a ten year
...
Detroit's properties were classified as delinquent.\footnote{See Reese
  ...
  contract between property tax payers and city government as broken."
  (p. 9) Another example of this can be seen in the 1990 tax payer
  ...
  ensuring voluntary tax payer compliance.}
...
problem, most delinquent tax payments are because residents forget or
...
Our empirical analysis reached two conclusions.  First, there is
...
strongly suggest tardy tax payers lack salience which is consistent with Akerlof's \citeyear{Akerlof-91} work
...
strongly supports the theory that tardy tax payers lack sufficient deterrence.
...
At a broader level, the impact of reminders and nudges is likely to be relatively modest compared to basic municipal governance considerations. The penalty nudges we tested improved the rate of compliance by 9 percent over no reminder at all, but contributed only 5 percent more money towards the total amount still owed. Cities need tax revenues to provide city services.  In a democracy, paying city taxes will depend to a large degree on the voluntary
compliance of city residents.  The best way to ensure that voluntary
payment and a stable city property tax base is to deliver the services
that citizens desire at competitive tax rates; see Haughwout, Inman,
Craig and Luce \citeyear{haughwout2004local}.  Still some taxpayers,
do not pay in a timely manner.  The best strategy to encourage
compliance among these taxpayers, at least among tardy Philadelphians,
is to signal a commitment to collect taxes due and to threaten
penalties if the taxpayer does not comply.\footnote{After completing our experiment, we shared our preliminary results with the City's Department of Revenue. This was prior to the normal time at which the Department would send reminder letters to the 2016 population of tardy taxpayers. The Department incorporated the lessons learned from our experiment into their standard letter for that year. In previous years, 24,000 accounts were sent to outside collection. In 2016, only 18,000 accounts required outside enforcement.}
