...
\usepackage{rotating}
\usepackage{natbib}
%AER citations style file available here:
%  http://tug.ctan.org/biblio/bibtex/contrib/economic/aer.bst
...
to ascribe to the notion. Specifically, we exhorted tax nonpayers in this 
...
Both are statistically significant. Results from logit models using 
