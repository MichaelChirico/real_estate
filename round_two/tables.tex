...
Amount Due & \$1,233 & \$1,383 & \$1,389 & \$1,613 & \$1,950 & \$1,290 & \$1,338 & \$1,316 & 0.32 \\ 
  ...
  Value & (\$509,738) & (\$1,316,580) & (\$699,574) & (\$966,870) & (\$2,035,732) & (\$181,107) & (\$181,940) & (\$1,336,669) &  \\ 
...
\hline
Reminder     & $3.7^{***}$  & $3.9^{***}$  & $2.2^{*}$    & $3.0^{**}$   \\
             & $(1.4)$      & $(1.5)$      & $(1.3)$      & $(1.5)$      \\
Lien         & $9.0^{***}$  & $9.2^{***}$  & $5.7^{***}$  & $7.3^{***}$  \\
             & $(1.4)$      & $(1.5)$      & $(1.3)$      & $(1.5)$      \\
Sheriff      & $7.3^{***}$  & $8.8^{***}$  & $4.5^{***}$  & $6.7^{***}$  \\
             & $(1.4)$      & $(1.5)$      & $(1.3)$      & $(1.5)$      \\
Neighborhood & $1.7$        & $2.6^{*}$    & $-0.2$       & $1.6$        \\
             & $(1.4)$      & $(1.5)$      & $(1.3)$      & $(1.5)$      \\
...
\hline
 & \multicolumn{2}{c}{Ever Paid} & \multicolumn{2}{c}{Paid in Full} \\
 & One Month & Three Months & One Month & Three Months \\
Reminder     & $34.3$ & $55.3$ & $25.7$ & $43.8$ \\
\hline
Lien         & $5.3^{***}$  & $5.3^{***}$  & $3.5^{***}$  & $4.2^{***}$  \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
Sheriff      & $3.6^{***}$  & $4.9^{***}$  & $2.3^{*}$    & $3.7^{***}$  \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
Neighborhood & $-2.1$       & $-1.2$       & $-2.5^{*}$   & $-1.5$       \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
Community    & $0.1$        & $-1.0$       & $-0.9$       & $-0.5$       \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
Peer         & $0.1$        & $-0.4$       & $-0.4$       & $0.3$        \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
Duty         & $-1.3$       & $-0.3$       & $-1.6$       & $-0.8$       \\
             & $(1.4)$      & $(1.4)$      & $(1.3)$      & $(1.4)$      \\
\hline
Num. obs.    & 16951        & 16951        & 16951        & 16951        \\
\hline
...
Reminder     & $1.3$        & $1.5$        & $-1.4$       & $-0.7$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Lien         & $3.7^{***}$  & $4.8^{***}$  & $-0.9$       & $-0.7$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Sheriff      & $3.7^{***}$  & $2.9^{**}$   & $-0.6$       & $-1.1$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Neighborhood & $-0.2$       & $-0.0$       & $-3.1^{**}$  & $-2.1$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Community    & $0.9$        & $1.1$        & $-1.8$       & $-2.0$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Peer         & $1.4$        & $2.3$        & $-1.9$       & $-1.1$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
Duty         & $2.1$        & $1.0$        & $-1.6$       & $-1.9$       \\
             & $(1.3)$      & $(1.4)$      & $(1.4)$      & $(1.5)$      \\
\hline
Num. obs.    & 19039        & 19039        & 19036        & 19036        \\
\hline
\multicolumn{5}{l}{\scriptsize{$^{***}p<0.01$, $^{**}p<0.05$, $^*p<0.1$. Holdout values in levels; remaining figures relative to this}}
\end{tabular}
\label{ltmpme}
