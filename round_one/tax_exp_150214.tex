...
restrictions discussed in more detailbelow). After identifying the bills to be 
...
to obtain the ID used by DOR, there appears to have been infrequent yet noteworthy
...
see the Appendix for more robust examination of these variables.
...
\noindent ALSO CAN'T FIGURE OUT HOW TO ADD .PS GRAPHICS
...
This can be seen in Figure \ref{fig:ever_paid}.
...
as seen in Figure \ref{fig:paid_full}, the trajectory of full
...
full repayment. Figure \ref{fig:paid_full} suggests full
...
\ref{fig:repay_quart}, which depicts the trajectories of (normalized) repayments
...
mirrored in the time series results of Figure \ref{fig:drawdown_quart}.
...
and in danger of becoming delinquent. (Non-payers are considered ÒlateÓ
...
delinquencies. The city also is considering creation of a Òland bankÓ
...
property-owners timetables usually set by the stateÑand are more
